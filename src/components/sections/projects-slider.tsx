      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-6 relative z-10">
        ...
        <div className="space-y-16">
          {projects.map((project: Project, index) => (
            <Card key={project.id} className="overflow-hidden bg-card/50 border-border/50 backdrop-blur-sm shadow-lg grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 md:p-8 transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
